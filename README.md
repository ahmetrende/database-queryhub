...
```bash
docker pull ghcr.io/ahmetrende/database-queryhub:1.0.7
QH_IMAGE=ghcr.io/ahmetrende/database-queryhub:1.0.7 docker compose -f docker-compose.install.yml up -d
```

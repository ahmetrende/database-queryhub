...
```bash
docker pull ghcr.io/ahmetrende/database-queryhub:1.0.22
QH_IMAGE=ghcr.io/ahmetrende/database-queryhub:1.0.22 docker compose -f docker-compose.install.yml up -d
```

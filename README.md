...
```bash
docker pull ghcr.io/ahmetrende/database-queryhub:1.0.18
QH_IMAGE=ghcr.io/ahmetrende/database-queryhub:1.0.18 docker compose -f docker-compose.install.yml up -d
```

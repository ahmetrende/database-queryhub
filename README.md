...
```bash
docker pull ghcr.io/ahmetrende/database-queryhub:1.0.13
QH_IMAGE=ghcr.io/ahmetrende/database-queryhub:1.0.13 docker compose -f docker-compose.install.yml up -d
```
